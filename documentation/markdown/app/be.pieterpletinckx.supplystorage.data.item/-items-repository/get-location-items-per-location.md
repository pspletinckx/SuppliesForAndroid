//[app](../../../index.md)/[be.pieterpletinckx.supplystorage.data.item](../index.md)/[ItemsRepository](index.md)/[getLocationItemsPerLocation](get-location-items-per-location.md)
